...
| checkpoint | mean | median | micro | 打切 |
|---|---:|---:|---:|---:|
| `v3-base` | 35.86% | 31.91% | 35.95% | 0/600 |
| `v3-s1v2-bf16-3000` | 31.21% | 28.00% | 31.22% | **7/600** |
| **`v3-s1v2-fp32-3000`** | **25.98%** | **22.86%** | 26.15% | **0/600** |

| 比較 | 差 | 95%CI | 改善/悪化 | MDE |
|---|---:|---|---|---:|
| base → bf16 | -4.65pt | [-5.97, -3.40] | 300/176 | 1.86pt |
| **base → fp32** | **-9.89pt** | [-11.27, -8.53] | 386/114 | 1.99pt |
| **bf16 → fp32** | **-5.23pt** | [-6.25, -4.21] | 325/141 | 1.47pt |
