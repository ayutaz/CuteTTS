...
| ~~2~~ | ~~**M3**~~ | 抑揚に効く手段を設計する（まず紙の上） | 不要 | 実測 約2h / $0 | **完了。診断 M3b を設計し、setを作った**（200組） |
| 3 | **F2 + M3b** | 数詞set 200文 + frontend込みの抑揚 + 参照差し替え + **韻律転写の診断** | 要（軽） | 約2.7h / 約$0.5 | R-039 の修正が音に効くか / J3 がアクセントを壊すか / **韻律を与えれば使えるか** |
