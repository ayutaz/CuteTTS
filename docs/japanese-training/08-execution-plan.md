...
| ~~2~~ | ~~**M4a**~~ | アクセント核をテキストに明示して学習する | 要 | 実測 約6h / 約$1.3 | **完了。抑揚は +0.93pt で基準未達。ただし読みCER -5.80pt（7.58%）**（R-045 / D-050） |
...
| `m4a-kana`（仮名化のみ） | 11.64% | 31.29% | 43.8% | 41.3% |
| **`m4a-accent`** | **7.58%** | **2.43%** | 47.0% | **47.1%** |

* **記号だけの効果は -4.06pt**（95%CI [-5.02, -3.06]）。仮名化だけは -1.74pt
