...
**F1 / M2 / D1 / G1 / M3 / F2 / M3b / D2 / C1 / T3 の9段すべて完了（2026-09-18）。**

**最良checkpointは C1**（batch16 × 30,000 step = 48万サンプル）。
読みCER **11.98%**（従来 13.38%、-1.40pt、有意）。
**次は F3（新最良を frontend 込みで測る）と M4（韻律を条件づける経路を作る）。**
