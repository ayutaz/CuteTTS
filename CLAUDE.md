...
| **M2** | 抑揚・アクセントの天井 | 別テイクが **27,367組**あると分かった。天井が出れば「抑揚に投資すべきか」を決められる | 提案 |
| **D1** | データ量の再測定 | 3,000 step の比較は大きいデータに不利だった。**30,000 step で測り直す**。S2 の進退を決める | 提案 |
| **C1** | 計算量4倍 | 効いているのは計算量。30,000 step の先に 1pt 以上が残っているか | 提案 |
| T3 | flow_copies / condition_dropout | 引数は既にある。期待値は低い | 提案 |
| S2 | 1,000時間 | **保留**。**D1 の結果で進退を決める** | 保留 |
